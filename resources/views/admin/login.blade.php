...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url('{{ asset("ejptemplate/admin/fonts/FuturaStdBook.otf") }}') format('opentype');
            font-weight: 400;
            font-style: normal;
        }
        @font-face {
            font-family: 'FuturaStd';
            src: url('{{ asset("ejptemplate/admin/fonts/FuturaStdMedium.otf") }}') format('opentype');
            font-weight: 500;
            font-style: normal;
        }
        @font-face {
            font-family: 'FuturaStd';
            src: url('{{ asset("ejptemplate/admin/fonts/FuturaStdHeavy.otf") }}') format('opentype');
            font-weight: 600;
            font-style: normal;
        }
        @font-face {
            font-family: 'FuturaStd';
            src: url('{{ asset("ejptemplate/admin/fonts/FuturaStdBold.otf") }}') format('opentype');
            font-weight: 700;
            font-style: normal;
        }
        @font-face {
            font-family: 'FuturaStd';
            src: url('{{ asset("ejptemplate/admin/fonts/FuturaStdExtraBold.otf") }}') format('opentype');
            font-weight: 800;
            font-style: normal;
        }
    </style>
